...
// FIX: Convert 16-char Gmail Hex ID to 32-char UUID format
// e.g. "19af..." -> "00000000-0000-0000-0000-19af..."
...
async function getEmailDetails(gmail, messageId) {
  ...
  // FIX: Return the UUID version of the ID
  return { 
    id: gmailIdToUuid(res.data.id), // UUID format
    originalId: res.data.id,        // Keep original just in case
